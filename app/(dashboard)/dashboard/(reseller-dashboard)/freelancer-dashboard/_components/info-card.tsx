...
export default function InfoCard() {
  return (
    <div className="flex flex-col xl:flex-row justify-between gap-4 xl:gap-10 mt-4 md:mt-6">
      {/* div 1 */}
      <div className="border-2 border-gray-200 flex flex-col md:flex-row gap-4 md:gap-12 p-4 md:px-12 md:py-6 rounded-lg w-full">
        <CompletedTasksIcon
        ...
        <div className="w-full">
          ...
          <span className="text-xl md:text-2xl text-black font-semibold block mt-2">
            24
          </span>
        </div>
      </div>
      {/* div 2 */}
      <div className="border-2 border-gray-200 flex flex-col md:flex-row gap-4 md:gap-12 p-4 md:px-10 md:py-6 rounded-lg w-full">
        <OnTimeDeliveryIcon
          className={"w-16 h-14 p-3 bg-gray-100 rounded-full"}
        />
        <div className="w-full">
