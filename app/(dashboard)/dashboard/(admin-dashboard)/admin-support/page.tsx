...
import PayoutModal from "../payment/_components/payout-modal";
import CreateNewEmailModal from "./_components/create-new-email-modal";
      ...
      <table className="min-w-full table-auto ">
        <thead className="bg-gray-100 text-gray-700 text-left rounded-t-lg">
          <tr>
            ...
            <th className="py-3 px-4">Recipients / From</th>
