              ...
              <tbody>
                <tr className="border-b">
                  ...
                  <td className="py-4">
                    ...
                    <div className="text-sm text-muted-foreground">jennings@example.com</div>
                  </td>
                  <td className="py-4">
                    <div className="font-medium">Social Media Post</div>
                    <div className="text-sm text-muted-foreground">With 3 Add Ons</div>
                  </td>
                ...
                <tr className="border-b">
                  ...
                  <td className="py-4">
                    <div className="font-medium">McDonald's</div>
                    <div className="text-sm text-muted-foreground">weaver@example.com</div>
                  </td>
                  <td className="py-4">
                ...
                <tr>
                  ...
                  <td className="py-4">
                    ...
                    <div className="text-sm text-muted-foreground">simmons@example.com</div>
                  </td>
                  <td className="py-4">
                    <div className="font-medium">SEO Backlinks</div>
                    <div className="text-sm text-muted-foreground">With 1 Add Ons</div>
                  </td>
