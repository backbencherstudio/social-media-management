          ...
          <div className="bg-white p-4 sm:p-6 rounded-lg shadow-sm">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
              <div className="border border-[#E9E9EA] p-4 rounded-md space-y-2">
                ...
                <p className="text-black text-sm md:text-base break-words max- w-full font-semibold">
                  {order.id}
                </p>
              </div>
              ...
              <div className="border border-[#E9E9EA] p-4 rounded-md space-y-2">
                ...
                <p className="text-black text-sm md:text-base font-semibold capitalize">
                  {order.payment_status}
                </p>
              </div>
              <div className="border border-[#E9E9EA] p-4 rounded-md space-y-2">
                <p className="text-gray-600 text-sm">Subscription</p>
                <div className="text-sm text-black flex items-center justify-start sm:justify-center w-fit px-3 py-1 rounded-full bg-[#EBFBF5] gap-1 font-semibold  ">
