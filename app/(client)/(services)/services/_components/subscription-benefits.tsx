...
const SubscriptionBenefits = () => {
  return (
    <div className="w-full max-w-[1200px] mx-auto  py-[60px] md:py-[80px] lg:py-[100px] px-5 2xl:px-0">
      ...
      <div className="lg:mt-9 md:mt-6 mt-4 mb-10 flex justify-center gap-4">
        <Link href="">
          <div className="border leading-[150%] lg:px-7 md:px-4 px-2 lg:py-4 md:py-3 py-2 flex md:text-base text-sm cursor-pointer items-center justify-start  rounded-[8px] gap-2 font-semibold  duration-500 hover:bg-[#070707] hover:text-white">
