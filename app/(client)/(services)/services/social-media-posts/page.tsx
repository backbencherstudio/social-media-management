...
export default function SocialMediaPostsPage() {
  return (
    <div>
      ...
      <ReuseableHero
        header={
          "Professional Post Design Services Starting at Just $149/mo to $99/mo"
        }
        para={[
      ...
      <PostExample
        header="Examples of Social media post"
        para="Get your design & marketing work done without the hassle of unreliable freelancers, costly agencies. Pay a fixed, monthly, and predictable rate, with no contracts or surprises."
      />
      <FrequentlyAsked />
    </div>
  );
