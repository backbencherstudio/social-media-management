...
const HowToWork = ({ heading }: { heading: string }) => {
  ...
  return (
    <div
      id="demo-video" 
      className="max-w-[996px] mx-auto lg:my-25 md:my-20 my-16 px-5 2xl:px-0"
    >
      ...
      <div className="border mt-8 py-[40px] md:py-[50px] lg:py-[62px] border-[#DFE1E7] rounded-[12px] px-1 md:px-0">
        <h1 className="text-center text-[#1D1D1F] text-[32px] font-semibold leading-[160%]">
          Get Started with TagGrowth Today
        </h1>
        <ParagraphText
