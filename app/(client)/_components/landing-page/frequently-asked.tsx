              ...
              >
                ...
                >
                  ...
                  <div className="relative">
                    <PlusIcon
                      className={`h-5 w-5 transition-all duration-300 ease-in-out transform absolute right-0 ${
                        openIndex === index
                          ? "opacity-0 rotate-160"
                ...
                <AccordionContent className="">
                  If you have any questions that aren't listed below, feel free
                  to schedule a demo to speak with someone from our team.
                </AccordionContent>
              </AccordionItem>
            ))}
          </Accordion>
