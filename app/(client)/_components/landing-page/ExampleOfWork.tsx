        ...
        <div className="max-w-[694px] mx-auto flex flex-col gap-4 text-center ">
          <div>
            <Heading
              ...
              className="lg:text-[42px] md:text-[36px] text-2xl leading-[126%] font-bold capitalize"
            />
          </div>
          <div>
            <ParagraphText
              className="text-[#1D1F2C] leading-[160%] tracking-[0.16px]"
              paraText="Get your design & marketing work done without the hassle of unreliable freelancers, costly
