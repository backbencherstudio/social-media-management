      ...
      <div className="container px-4 2xl:px-0">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center py-8 gap-6 lg:gap-4">
          ...
          <div className="flex flex-col lg:flex-row items-start lg:items-center gap-4">
            <h4 className="text-[#1D1D1F] text-2xl font-bold whitespace-nowrap">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 py-8 border-t border-gray-200">
          ...
          <div className="lg:pr-12 col-span-1 sm:col-span-2 lg:col-span-1">
            <p className="text-gray-600 text-sm">
              TagGrowth is a flexible subscription-based service enabled by
          ...
          {/* TagGrowth Links */}
          <div>
            <h4 className="text-[#1B1D28] text-lg font-semibold mb-4">
              TagGrowth
            </h4>
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/pricing-and-package" className="hover:text-black">
                  Pricing
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/book-demo" className="hover:text-black">
                  Book a Demo
                </Link>
              </li>
            </ul>
          ...
          {/* Services */}
          <div>
            <h4 className="font-semibold mb-4 text-[#1B1D28] text-lg ">
              Services
            </h4>
            <ul className="space-y-2 text-sm">
              <li>
              ...
              <li>
                <Link href="/services/short-video" className="hover:text-black">
                  Short-Form Videos
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/services/seo-blogs" className="hover:text-black">
                  SEO Blog posts
                </Link>
              </li>
              <li>
                <Link href="/become-reseller" className="hover:text-black">
                  Become a Reseller
                </Link>
              </li>
            </ul>
        ...
        <div className="flex flex-col lg:flex-row justify-between items-center py-6 border-t border-gray-200 text-xs text-gray-500 gap-4">
          <div className="order-3 lg:order-none">
            &copy; TagGrowth. All rights reserved.
          </div>

          <div className="flex flex-wrap justify-center items-center gap-4 order-2 lg:order-none">
            <Link href="/terms" className="hover:text-black whitespace-nowrap">
              Terms & Conditions
            </Link>
