    ...
    <div className="w-full max-w-[520px] h-[500px] bg-[#F7F7F9] p-6 rounded-2xl flex flex-col justify-between">
      <div className="space-y-2">
        <div className="flex justify-between items-center">
          ...
          <p className="bg-white p-2 rounded-xl">{category}</p>
        </div>
        <h3 className="text-xl font-semibold text-[#1D1D1F] mt-[28px] line-clamp-2">
          {name}
        </h3>
        <p className="text-sm text-[#4A4C56] leading-relaxed mt-[12px] mb-[36px] line-clamp-3">
          {description}
        </p>
      </div>
      ...
      <div className="mt-auto">
        ...
        <div className="space-y-4">
          ...
          <Button className="w-full bg-black text-white hover:bg-gray-800 rounded-lg flex items-center justify-center gap-2 h-12">
            Get Started
            <svg
              className="w-5 h-5"
              viewBox="0 0 24 24"
