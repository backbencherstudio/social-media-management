    ...
    return (
        <div className=" max-w-[1200px] mx-auto 2xl:px-0 px-5 lg:pb-[100px] md:pb-[80px] pb-[60px]">
            ...
            <div className='md:max-w-[632px] mx-auto text-center mb-8 md:mb:12'>
                ...
                />
                <ParagraphText
                    paraText="Quality social media management drives brand growth, but keeping up with platforms, formats, and testing is challenging. Here are three common approaches:"
