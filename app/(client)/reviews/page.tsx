...
export default function Reviews() {
  const reviews = [
    ...
    },
    {
      ...
      name: "Stephen K.",
      position: "Founder & CEO",
      quote: "The process of reviewing and requesting revisions was streamlined to perfection a feature that saved me an invaluable amount of time!. The process of reviewing and requesting revisions was streamlined to perfection a feature that saved me an invaluable amount of time!"
    },
    {
      id: 4,
      image: profileThree,
