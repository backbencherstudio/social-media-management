  ...
  const data = [
    {
      ...
      description:
        "Get familiar with the process and next steps, by watching this 3-min onboarding video.",
  ...
  return (
    <div className="flex flex-col md:flex-row w-full gap-4 py-10">
      ...
      <div className="flex flex-col gap-4 md:w-6/12 w-full ">
        <div className="bg-white rounded-lg px-6 py-2 h-full">
          <div className="flex flex-col items-center md:flex-row justify-between w-full gap-4">
            <div className="md:w-5/12 w-full">
              ...
              <p className="text-gray-600 mt-2">
                Access our comprehensive help articles for quick solutions to
        ...
        <div className="bg-white rounded-lg px-6 py-2  h-full">
          <div className="flex flex-col items-center md:flex-row justify-between w-full gap-4 h-full">
            <div className="md:w-5/12 w-full">
              ...
              <button className="mt-4 flex items-center bg-gray-100 hover:bg-gray-200 rounded-lg px-4 py-2 capitalize">
                Invite your team
                <svg
                  className="w-4 h-4 ml-2"
                  viewBox="0 0 24 24"
            ...
            <div className="border border-gray-200 rounded-lg px-15 py-12 md:w-7/12 w-full grid grid-cols-3 gap-4">
              <div className="w-10 h-10 bg-white rounded-full flex items-center justify-center border border-gray-200/50">
                <User className="w-5 h-5 text-gray-500" />
              </div>
              <div className="w-10 h-10 bg-gray-200/50 rounded-full flex items-center justify-center border border-gray-200/50">
                <User className="w-5 h-5 text-gray-500" />
              </div>
              <div className="w-10 h-10 bg-white rounded-full flex items-center justify-center border border-gray-200/50">
                <User className="w-5 h-5 text-gray-500" />
