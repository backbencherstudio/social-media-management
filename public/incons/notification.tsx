...
const NotificationIcon: React.FC<NotificationIconProps> = ({
  ...
  return (
    ...
    >
      ...
      />
      <path
        d="M12.5176 15.8838C12.5176 17.2588 11.3926 18.3838 10.0176 18.3838C9.33425 18.3838 8.70091 18.1005 8.25091 17.6505C7.80091 17.2005 7.51758 16.5671 7.51758 15.8838"
        stroke="#161618"
        strokeWidth="1.5"
        strokeMiterlimit="10"
      />
